    ...
    <section id="about" className="scene">
      <div className="sec-wrap">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          <div className="glass-panel reveal-up" style={{ padding: '40px 32px' }}>
          ...
          <div className="glass-panel reveal-up" style={{ padding: '40px 32px', transitionDelay: '0.1s' }}>
          ...
          <div className="glass-panel reveal-up" style={{ padding: '40px 32px', transitionDelay: '0.2s' }}>

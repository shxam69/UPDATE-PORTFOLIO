    ...
    >
      <div className="sec-wrap">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '24px' }}>
          <div className="solid-panel reveal-up" style={{ padding: '40px 32px' }}>
          ...
          <div className="solid-panel reveal-up" style={{ padding: '40px 32px', transitionDelay: '0.1s' }}>
          ...
          <div className="solid-panel reveal-up" style={{ padding: '40px 32px', transitionDelay: '0.2s' }}>
